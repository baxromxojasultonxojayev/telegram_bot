...
class Database {
  ...
  async setName(chat_id, name){
    return await this.users.updateOne({chat_id:chat_id}, {name})
  }
  async setStep(chat_id, step){
    return await this.users.updateOne({chat_id:chat_id}, {step})
  }
  async setAge(chat_id, age){
    return await this.users.updateOne({chat_id:chat_id}, {age})
  }
